...
export const Route = createFileRoute("/ai-insights")({
  head: () => ({
    meta: [
      { title: "AI Insights — CallVibe" },
      {
        name: "description",
        content:
          "Aggregate AI analysis of GT Holidays conversations: sales quality scoring, conversation drivers, trip classifications and generated travel insights.",
      },
      { property: "og:title", content: "AI Insights — CallVibe" },
      { property: "og:description", content: "Sales quality scoring and traveller classification across all conversations." },
    ],
  }),
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-3 xl:grid-cols-6">
        <MetricTile label="Conversations Analysed" value="5,986" sub="Calls + WhatsApp" />
        <MetricTile label="Avg Sales Quality" value="80%" sub="8 scored dimensions" />
        <MetricTile label="Avg Traveller Intent" value="58" sub="Portfolio average" />
        <MetricTile label="Objection Handling" value="7.4/10" sub="Weakest dimension" />
        <MetricTile label="Destination Knowledge" value="8.6/10" sub="Strongest dimension" />
              ...
              <div className="border-t border-border px-4 py-2.5">
                <Legend
                  items={[
                    ...
                    { label: "Traveller intent", color: "var(--color-success)" },
                  ]}
                />
              </div>
            </Panel>
      ...
      {tab === "Conversation Drivers" ? (
        <div className="grid gap-4 xl:grid-cols-[1.4fr_1fr]">
          <Panel>
            <PanelHead title="What Travellers Talk About" subtitle="Detected topics across conversations" icon={<BrainCircuit className="h-3.5 w-3.5" />} />
      ...
      {tab === "Generated Insights" ? (
        <Panel>
          <PanelHead
            ...
            subtitle="Automatically generated from traveller conversations"
