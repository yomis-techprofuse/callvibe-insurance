...
export const Route = createFileRoute("/sales-advisors")({
  head: () => ({
    meta: [
      { title: "Sales Advisors — Marhaba Intelligence" },
      { name: "description", content: "Advisor performance and AI coaching: conversation volume, sales quality scores, objection handling and site-visit conversion." },
      { property: "og:title", content: "Sales Advisors — Marhaba Intelligence" },
      ...
      {tab === "Performance" ? (
        <div className="grid gap-4 xl:grid-cols-[1.5fr_1fr]">
          ...
          <div className="space-y-4">
            ...
            <Panel>
              <PanelHead title="Projects Handled" />
              <div className="px-4 py-3.5">
                <HBarList items={active.topProjects} />
              </div>
            </Panel>
          </div>
        </div>
