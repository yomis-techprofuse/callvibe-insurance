...
export const Route = createFileRoute("/market-intelligence")({
  head: () => ({
    meta: [
      { title: "Market Intelligence — Marhaba Intelligence" },
      { name: "description", content: "Competitor mentions, comparison reasons, emerging buyer trends and lead-source quality derived from Dubai buyer conversations." },
      { property: "og:title", content: "Market Intelligence — Marhaba Intelligence" },
      { property: "og:description", content: "Competitor pressure and lead-source quality from buyer conversations." },
    ],
  }),
  component: MarketIntelligence,
});

const TABS = ["Competitors", "Buyer Trends", "Lead Sources"];
    ...
    <div className="space-y-4">
      ...
      {tab === "Competitors" ? (
        <>
          <div className="grid gap-4 xl:grid-cols-[1.5fr_1fr]">
            <Panel>
              <PanelHead title="Competitor Mention Trend" subtitle="Weekly mentions across buyer conversations" icon={<TrendingUp className="h-3.5 w-3.5" />} />
            ...
            <Panel>
              <PanelHead title="Why Buyers Compare" subtitle="Share of comparison conversations" />
      ...
      {tab === "Buyer Trends" ? (
        <div className="grid gap-4 xl:grid-cols-[1fr_1.3fr]">
          <Panel>
            <PanelHead title="Emerging Buyer Trends" subtitle="Change in mention volume vs previous period" />
            <div className="px-4 py-3.5">
